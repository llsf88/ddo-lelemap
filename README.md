...
**Debug / debug+ -** gera debug dump em 'my maps'; o debug+ mostra mais dados no tooltip.  
...
**Show [s] -** mostra ou esconde entidades persistidas.  
...
**Transp. Blacks -** remove áreas pretas grandes da imagem do mapa.  
...
**Debug / debug+ -** writes a debug dump to 'my maps'; debug+ shows more data in the tooltip.  
...
**Show [s] -** shows or hides persisted entities.  
